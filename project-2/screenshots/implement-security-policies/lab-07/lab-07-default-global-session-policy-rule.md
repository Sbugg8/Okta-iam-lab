...
[![Add Rule Configuration - Policy Settings](https://github.com/Sbugg8/Okta-iam-lab/raw/main/project-2/screenshots/implement-security-policies/lab-07/lab07a-add-a-rule-to-default-global-session-policy.png)](/Sbugg8/Okta-iam-lab/blob/main/project-2/screenshots/implement-security-policies/lab-07/lab07a-add-a-rule-to-default-global-session-policy.png) *Top half of the Add Rule form showing the Standards rule's policy settings — User's IP set to Anywhere, Identity provider Any, Authenticates via Any, Access Allowed. Session establishment delegated to the Authentication Policy requirements, with MFA enforcement also handled there.*

[![Add Rule Configuration - Session Management](https://github.com/Sbugg8/Okta-iam-lab/raw/main/project-2/screenshots/implement-security-policies/lab-07/lab07b-add-a-rule-to-default-global-session-policy.png)](/Sbugg8/Okta-iam-lab/blob/main/project-2/screenshots/implement-security-policies/lab-07/lab07b-add-a-rule-to-default-global-session-policy.png) *Bottom half of the Add Rule form configuring Okta global session management — 12-hour maximum lifetime, 30-minute idle timeout, and persistent cookies disabled. The form's help text confirms the Okta global session is also referred to as the Okta IdP session or Single Sign-On (SSO) session.*

[![Standards Rule Active in Default Policy](https://github.com/Sbugg8/Okta-iam-lab/raw/main/project-2/screenshots/implement-security-policies/lab-07/lab07-standard-global-session-policy-created.png)](/Sbugg8/Okta-iam-lab/blob/main/project-2/screenshots/implement-security-policies/lab-07/lab07-standard-global-session-policy-created.png) *Default Policy view after creation, confirming the Standards rule is active at Priority 1 above the system Default Rule at Priority 2. The "Assigned to groups: Everyone" line confirms this policy applies to all users in the org by default.*
